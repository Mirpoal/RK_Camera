...
public class MediaPlayer extends VLCObject<MediaPlayer.Event> {
    ...
    public boolean snapShot(String file, int width, int height) {
        return nativeSnapShot(0, file, width, height);
    }
    ...
    private native boolean nativeSnapShot(int num, String file, int width, int height);
}
